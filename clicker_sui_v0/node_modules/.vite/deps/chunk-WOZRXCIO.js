...
// node_modules/.pnpm/@mysten+sui@1.45.2_typescript@5.9.3/node_modules/@mysten/sui/dist/esm/client/network.js
...
var JSONRpcCoreClient = class extends Experimental_CoreClient {
  ...
  async defaultNameServiceName(options) {
    const name = (await __privateGet3(this, _jsonRpcClient).resolveNameServiceNames(options)).data[0];
    return {
      data: {
        name
      }
  ...
  resolveTransactionPlugin() {
    return jsonRpcClientResolveTransactionPlugin(__privateGet3(this, _jsonRpcClient));
  }
  async getMoveFunction(options) {
    const result = await __privateGet3(this, _jsonRpcClient).getNormalizedMoveFunction({
...
//# sourceMappingURL=chunk-WOZRXCIO.js.map
